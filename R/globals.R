...
'id', 'ids', 'data.s', 'idVar', 'X', 'Z', 'betas.new', 'densLong', 'sigma.new', 'newdata', 'densRE', 'indFixed', 'indRandom', 'alphas.new', 'weightFun', 'shapes.new', 'max.time', 'estimateWeightFun', 'type','Time',
